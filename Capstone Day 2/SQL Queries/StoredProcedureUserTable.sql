...
CREATE OR REPLACE PROCEDURE "insertUser"("_firstName" VARCHAR, "_lastName" VARCHAR, "_username" VARCHAR, 
										  "_phone" VARCHAR,"_emailId" VARCHAR, "_password" VARCHAR, 
										  "_emailVerified" BOOLEAN, "_createdOn" TIMESTAMP WITHOUT TIME ZONE)
